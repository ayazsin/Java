...
public class Lists01 {
	...
	public static void main(String[] args) {
		...
		//But when you use Arrays.asList()  method data types of array elements should be 
		//"non-primitive". I mean instead of "int", use "Integer" etc.
		...
		/*
		 When you run the following code you wil get "UnsupportedOperationException" because
		 the list id created from an array, and the list has some array features. The significant
		 array feature is to fix in length. So if you create a list from an array, you cannot use any 
		 list method which changes the size
		 */
//		l3c.add(7);
//		System.out.println(l3c);
//		
