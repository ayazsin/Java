...
public class String01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(s1.lastIndexOf('e'));//10 <== lastIndexOf() accepts char as a parameter
		...
		System.out.println(s1.lastIndexOf('a', 10));//9 <== latIndexOf() gets the first 5 characters in that example
		  											//		then returns the index of a
		
		System.out.println(s1.lastIndexOf("e", 14));//11
		System.out.println(s1.lastIndexOf("n", 5));//4
		/*
	   ...
	   */
		...
		//10.Method: startsWith()  <== Used to check the initial of String + Returns boolean
		...
		//12.Method: is Empty() <== Checks if a String is empty String or not + Returns boolean
		...
		System.out.println(s5.concat(s6)); //AliCan <== + --> Addition for integers
										   //	  	<== + --> for chars
										   //		<== + --> for Strings
		System.out.println(s5.concat(s6).concat(" Woow!"));//Alican Woow!
		...
		System.out.println(s8.replace("Java", "Phyton"));//Phyton ahh Python!...
		...
		System.out.println(s2.startsWith("i",5)); //False!
