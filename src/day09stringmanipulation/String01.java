...
public class String01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(s1.substring(8, 12));//easy  <==There is no index 12 but Java will not work
												// 			with 12, it will use 11 at the end and index 11 exists
		System.out.println(s1.substring(8));//easy 
		...
		// System.out.println(s3.substring(5,3));//Run time error ==> Starting index cannot be greater than ending index
		
		//System.out.println(s3.substring(a,4));//Compile time error
		...
		//16. Method: trim() <== Used to remove space character from the beginnig and end + Return nothing
		String s4 = "  Ali Can  ";
		...
		//18. Method: replaceAll() <== Used like replace() + returns Strinf
