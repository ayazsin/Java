...
public class CustomExceptions01 {
	...
	public static void divide(int x, int y) throws DivideByOneException{
		if(y==1) {
			throw new DivideByOneException("Divide a number by 1 gives the number itself, no need to divide");
		}
	...
	/*
	 	When you create a "Custom Exception":
	 	  A) For "Checked Custom Exception";
	 		1)Put "Exception" word at the end of the Custom Exception class name like
