...
public class Variable01 {
	...
	/*
	 	Note: 	If you create a variable inside a method, you should "initialize" it.
	 			...
	 			"= 100" means you initialized variable
	 	...
	 	Note:	If you don't assign any for a variable, Java uses "default values"
	 			for them. Default values for
	 			a)int ==> 0
	 			  Note: ints are whole numbers from -2,147,483,648 to -2,147,483,647
	 			b)double ==> 0.0
	 			c)float ==> 0.0
	 				Note: When you assign a value a float variable use "f" or "F" at the end
	 			d)char ==> nothing or '\u0000'
	 			e)byte ==> 0
