package day15constructors;
	...
	/*
		We use instance variables in constructors as parameters, because constructors create
		object and they use object related variables which are instance variables.
		
		We don't use class variables inside the constructors, because class variables
		are related with class not with objects
	*/
		...
		/*
		 	...
		 	3) In a constructor, how many times can "this()" be used?
		 		Answer: At most once. Because this() must be in the first line, if you use
		 				more than once where will you put it? You need to put it into second,
		 				third, etc.. lines but it is not allowed.
