...
public class E03 {
	...
	public static void main(String[] args) {
		...
		try {	
			...
			System.err.println("Do not use non-existing index" + e.getMessage());
		}
		...
		String s1 = "123";
		int num1 = Integer.parseInt(s1);//convert string to number
		System.out.println(num1 + 5);//128
		
		String s2 = "1a2b3c";
		try {
			int num2 = Integer.parseInt(s2);//NumberFormatException
			System.out.println(num2 + 5);//128
		} catch (NumberFormatException e) {
			System.err.println("You used non-digit characters in the String");
		}
