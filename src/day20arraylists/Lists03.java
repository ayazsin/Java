...
public class Lists03 {
	...
	public static void main(String[] args) {
		...
		//List1 changes below
		//addAll() method adds the elemnts at the end
		...
		//clear() method returns nothing ==>return typr is void
//		list2.clear();
//		System.out.println(list2); //[]
		
		//How to check existence of multible elemets
		...
		//It returns true if any element is removed otherwise is returns false
		...
		//As you know, arrrays are not flexible in length, the list which is created from an array
		//will not be flexible in size.
